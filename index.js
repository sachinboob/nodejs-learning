...
const ISSUES_FEED_URL = `http://jgpngit.jadeglobal.com/edi-test-tool/edi-test-tool/issues.atom?rss_token=<hidden>&scope=all&sort=created_date&state=all&utf8=%E2%9C%93`;
const MAX_PAGE = 1; // Increase to get more issues
...
for (var i = 1; i <= MAX_PAGE; i++) {
  let parser = new Parser({
    customFields: {
      ...
      item: ["labels", "milestone", "updated", "description"]
    }
  });
